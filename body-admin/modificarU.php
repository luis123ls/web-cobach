                                    ...
                                    <ul class="nav nav-tabs customtab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#setting"
                                                role="tab">Configuración</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                        <!-- Setting Tab start -->
                                        <div class="tab-pane fade height-100-p fade show active" id="setting"
                                            role="tabpanel">
                                            <div class="profile-setting">
                                                <form action="../body-php/controlador/editU.php" method="POST"
                                                    enctype="multipart/form-data">
                                                    <ul class="profile-edit-list row">
                                                        <li class="weight-500 col-md-6">
                                                            <h4 class="text-blue h5 mb-20">Informacion personal</h4>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control form-control-lg" type="file"
                                                                    name="f_perfil" value="<?php echo $f_perfil; ?>"
                                                                    required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control form-control-lg" type="date"
                                                                    name="fechaN" value="<?php echo $fechaN; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Ciudad</label>
                                                                <input class="form-control form-control-lg" type="text"
                                                                    name="ciudad" value="<?php echo $ciudad; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control form-control-lg" type="text"
                                                                    name="Cpostal" value="<?php echo $Cpostal; ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Direccion</label>
                                                                <input class="form-control form-control-lg" tapy="text"
                                                                    name="Direccion"
