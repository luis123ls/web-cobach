<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
  ...
  <form name="formEvento" id="formEvento" action="../body-php/controlador/nuevoEvento.php" class="form-horizontal" method="POST">
		<div class="form-group">
			<label for="evento" class="col-sm-12 control-label">Nombre del Evento</label>
      <div class="col-sm-10">
				<input type="hidden" class="form-control" name="id_sesion" id="id_sesion" placeholder="Nombre del Evento" value = "<?php echo $_SESSION['id_user'];?>" required/>
			</div>
			<div class="col-sm-10">
